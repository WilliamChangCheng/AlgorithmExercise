...
/**
 * 题目
 * Given an leetcode.array A of non-negative integers, return an leetcode.array consisting of all the even elements of A, followed by all the odd elements of A.
 * You may return any answer leetcode.array that satisfies this condition.
 *
 * Example 1:
 * Input: [3,1,2,4]
 * Output: [2,4,3,1]
