package leetcode.linkList.palindromeLinkedLlist;
 ...
 * public class leetcode.linkList.ListNode {
 * int val;
 * leetcode.linkList.ListNode next;
 * leetcode.linkList.ListNode(int x) { val = x; }
 * }
 */
...
public class MainClass {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            //leetcode.linkList.ListNode head = stringToListNode("[1,0,1]");
...
//            boolean ret = new Solution().isPalindrome(head);
            ...
            //leetcode.linkList.ListNode test = new Solution().reverse(head);
